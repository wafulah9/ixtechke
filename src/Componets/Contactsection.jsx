...
const Contactsection = () => {
    ...
    return (
        <motion.section 
          ...
          whileInView="show"
          viewport={{ once: true }}
        id='contacts' className="relative text-gray-600 body-font
            bg-gradient-to-b from-gray-100 to-white py-12 px-4 sm:px-16 lg:px-20 md:px-20">
            <motion.div 
            ...
            className="max-w-7xl mx-auto">
                ...
                {successMessage && (
                    <div style={{
                        ...
                        zIndex: 1000, // Ensures the message is above other elements
                    }}>
                        {successMessage}
                    </div>
                )}
